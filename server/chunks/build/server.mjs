import { version, unref, inject, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, resolveComponent, useSSRContext, createApp, effectScope, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, computed, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, mergeProps, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, withCtx, createTextVNode } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B1dsMVUi.mjs')
  }
];
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "text-center py-6" }, _attrs))}><p>Copyright © || 2024 || By Oleg Volmolov</p></footer>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ByN1PuL8.mjs'));
